# Last updated: 8/7/2025, 4:05:24 PM
class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        # - Window stores the frequency of how many characters we need
        # - countT stores the frequency of required characters in a substr
        # TC - O(n)
        # SC - O(n)
